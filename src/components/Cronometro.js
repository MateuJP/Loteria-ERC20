...
class Cronometro extends Component {
    constructor(props) {
        ...
        if (storedStart) {
            ...
            localStorage.setItem('cronometro_start', this.startTime); // Guardar el tiempo de inicio en el almacenamiento local
        }
    ...
    render() {
        ...
        return (
            <div className="cronometro-container">
                <h1 className="display-4 text-danger">Próximo Sorteo en</h1>
