...
class Ganador extends Component {
  ...
  _generarGanador = async () => {
    try {
      console.log("Generación del Ganador en Ejecución...");
  ...
  _ganador = async () => {
    try {
      console.log("Visualicación del Ganador en Ejecución...");
      const _ganador=await this.state.contract.methods.ganador().call();
      Swal.fire({
        icon: 'success',
        title: 'El Ganador ha sido :  ',
        text : `${_ganador}`,
        width: 800,
        padding: '3em',
        backdrop: `
